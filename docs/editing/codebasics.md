...
MetaDescription: Learn about the basic editing feature/codebasics/code-basics-ss of Visual Studio Code. Search, multiple selection, code formatting.
MetaSocialImage: imagesocial.png
---
# Basic editing
